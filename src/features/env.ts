...
export const APP_ENV = {
  ...
  LLM_BASE_URL: getOptionalEnv("LLM_BASE_URL"),
  LLM_API_KEY: getOptionalEnv("LLM_API_KEY"),
  CODEX_APP_SERVER_URL:
    getOptionalEnv("CODEX_APP_SERVER_URL") ?? "ws://codex:4500",
  CODEX_APP_SERVER_TOKEN:
    getOptionalEnv("CODEX_APP_SERVER_TOKEN") ?? "context-tg-internal",
  CODEX_MODEL: getOptionalEnv("CODEX_MODEL"),
  ...
  LLM_TEMPERATURE: getOptionalNumberEnv("LLM_TEMPERATURE") ?? 0.2,
